...
class ResidentialProofBloc extends Bloc {
  AppLoading? appLoading;

  ResidentialProofBloc(AppLoading appLoading) {
    this.appLoading = appLoading;
  }

  addResidentialProof(FormData formData) {
    DioDhanvarshaWrapper(
        ...
        formData,
        NetworkConstants.networkUrl.uploadResidentialProof())
        .postDioResponse();
  }
