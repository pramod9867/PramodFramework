          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                child: Text("My Profile",style: CustomTextStyles.boldMediumFont),
              ),
            ),
            ...
            Container(
              width: double.infinity,
              padding: EdgeInsets.only(top: 10,bottom: 10),
              child: Text("Application Updates",style: CustomTextStyles.boldMediumFont),
            ),
            GestureDetector(
              onTap: (){
                Navigator.push(
              ...
              child: Container(
                width: double.infinity,
                padding: EdgeInsets.only(top: 10,bottom: 10),
                child: Text("Get Help",style: CustomTextStyles.boldMediumFont),
              ),
            ),
            Divider(
              color: AppColors.light,
